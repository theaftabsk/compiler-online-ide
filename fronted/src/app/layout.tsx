...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Online C Compiler - Run C Program Online (GCC 13) | Kaspro by ITVEXO',
    template: '%s | Online C Compiler - Kaspro by ITVEXO',
  },
  description: 'Fastest Online C Compiler & C IDE by ITVEXO. Write, compile, and run C code online using GCC 13.3 with interactive terminal input for scanf in 30ms. Free, secure, zero setup.',
  keywords: [
    'online c compiler',
    'c compiler online',
